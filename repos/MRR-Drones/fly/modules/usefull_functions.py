...
def __normalize_image(image):
    ...
    normalized_image = Image.fromarray(
        (normalized_image_array * 255).astype(np.uint8))
...
def get_screenshot():
    ...
    # Normalize the screenshot
    normalized_screenshot = __normalize_image(screenshot)
    # save image
    normalized_screenshot.save("test.png")
    # return a Pil image
